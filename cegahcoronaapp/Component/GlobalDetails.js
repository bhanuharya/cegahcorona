    ...
    render() {
      ...
      <View style={styles.container}>
          ...
          <View style={styles.body}>
              <TouchableOpacity>
                  <Text style={styles.searchBar}>Cari Negara...</Text>
              </TouchableOpacity>
  
              <Text style={{color:'black', fontSize: 18, paddingTop: 20, paddingBottom: 20, fontWeight: 'bold'}}>COVID-19 Statistics - China</Text>
